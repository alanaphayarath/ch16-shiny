...
ui <- fluidPage(
  h1("First Shiny Wesbite"),
  p("I'm excited to ", strong("create"), " this website", strong("!!!!")),
  img("", src="https://media2.giphy.com/media/l3q2Ip7FrmPE33EiI/giphy.gif"),
  p("This slider does something", em("this is italicised")),
  sliderInput("slider", "This is a slider", 10, 100, 50)
)
